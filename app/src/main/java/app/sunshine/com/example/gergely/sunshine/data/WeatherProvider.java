...
import app.sunshine.com.example.gergely.sunshine.data.WeatherDbHelper;
...
public class WeatherProvider extends ContentProvider {
    ...
    //This class helps construct querries
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        //cursor will register a content observer to watch for changes to happaned with that uri
        //This provides the content provider to easily tell the UI when the cursor changes
        //e.g:on database update or insert
